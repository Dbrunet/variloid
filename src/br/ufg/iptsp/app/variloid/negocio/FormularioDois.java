...
public class FormularioDois {

	private long id;
	private String nomeCrianca;
    private String lesaoSugestivaVaricela;
	...
	// Parte dois
	private String erupcaoDifusaAgudo;
	...
	private String dataInicioRash;
	private String localizacaoRash;
	private String primeiralocalizacaoRash;
	private String numLesoes;
	private String maculoPapular;
	private String vesicular;
	private String crosta;
	private String maioriaLesoes;
	private String diagnosticoFeitoPor;
	...
	private String idSwabColetadoMaculoPapular;
	private String idSwabColetadoVesicula;
	private String idSwabColetadoCrosta;
	private String observacoesRelacionadasCaso;
    private Arquivo cartaoVacina;
    private Arquivo panoramica;
	...
	public String getErupcaoDifusaAgudo() {
		return erupcaoDifusaAgudo;
	}

	public void setErupcaoDifusaAgudo(String erupcaoDifusaAgudo) {
		this.erupcaoDifusaAgudo = erupcaoDifusaAgudo;
	}
	...
	public String getDataInicioRash() {
		return dataInicioRash;
	}

	public void setDataInicioRash(String dataInicioRash) {
		this.dataInicioRash = dataInicioRash;
	}

	public String getLocalizacaoRash() {
		return localizacaoRash;
	}

	public void setLocalizacaoRash(String localizacaoRash) {
		this.localizacaoRash = localizacaoRash;
	}

	public String getPrimeiralocalizacaoRash() {
		return primeiralocalizacaoRash;
	}

	public void setPrimeiralocalizacaoRash(String primeiralocalizacaoRash) {
		this.primeiralocalizacaoRash = primeiralocalizacaoRash;
	}

	public String getNumLesoes() {
		return numLesoes;
	}

	public void setNumLesoes(String numLesoes) {
		this.numLesoes = numLesoes;
	}

	public String getMaculoPapular() {
		return maculoPapular;
	}

	public void setMaculoPapular(String maculoPapular) {
		this.maculoPapular = maculoPapular;
	}
	...
	public String getCrosta() {
		return crosta;
	}

	public void setCrosta(String crosta) {
		this.crosta = crosta;
	}

	public String getMaioriaLesoes() {
		return maioriaLesoes;
	}

	public void setMaioriaLesoes(String maioriaLesoes) {
		this.maioriaLesoes = maioriaLesoes;
	}

	public String getDiagnosticoFeitoPor() {
		return diagnosticoFeitoPor;
	}

	public void setDiagnosticoFeitoPor(String diagnosticoFeitoPor) {
		this.diagnosticoFeitoPor = diagnosticoFeitoPor;
	}
	...
	public String getIdSwabColetadoMaculoPapular() {
		return idSwabColetadoMaculoPapular;
	}

	public void setIdSwabColetadoMaculoPapular(
			String idSwabColetadoMaculoPapular) {
		this.idSwabColetadoMaculoPapular = idSwabColetadoMaculoPapular;
	}

	public String getIdSwabColetadoVesicula() {
		return idSwabColetadoVesicula;
	}

	public void setIdSwabColetadoVesicula(String idSwabColetadoVesicula) {
		this.idSwabColetadoVesicula = idSwabColetadoVesicula;
	}

	public String getIdSwabColetadoCrosta() {
		return idSwabColetadoCrosta;
	}

	public void setIdSwabColetadoCrosta(String idSwabColetadoCrosta) {
		this.idSwabColetadoCrosta = idSwabColetadoCrosta;
	}
	...
	public Arquivo getLesaoColetada() {
		if (lesaoColetada == null) {
			lesaoColetada = new Arquivo();
		}
		return lesaoColetada;
	}

	public void setLesaoColetada(Arquivo lesaoColetada) {
		this.lesaoColetada = lesaoColetada;
	}
	...
	public String getLesaoSugestivaVaricela() {
		return lesaoSugestivaVaricela;
	}

	public void setLesaoSugestivaVaricela(String lesaoSugestivaVaricela) {
		this.lesaoSugestivaVaricela = lesaoSugestivaVaricela;
	}
	...
	public Arquivo getPanoramica() {
		return panoramica;
	}

	public void setPanoramica(Arquivo panoramica) {
