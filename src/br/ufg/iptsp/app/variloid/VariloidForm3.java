...
public class VariloidForm3 {
	...
	/** campos Formlario 2 */
	public static final int[] campos = new int[] { R.string.formulario3_nome,
			R.string.formulario3_sexo, R.string.formulario3_data,
			R.string.formulario3_ja_teve_catapora,
			R.string.formulario3_contato_com_ja_teve_catapora,
			R.string.formulario3_local_contato,
			R.string.formulario3_residencia,
			R.string.formulario3_tipo_logradouro,
			R.string.formulario3_nome_logradouro, R.string.formulario3_qudra,
			R.string.formulario3_lote, R.string.formulario3_numero,
			R.string.formulario3_complemento, R.string.formulario3_bairro,
			R.string.formulario3_titulo_criterio_inclusao, R.string.formulario3_tcle,
			R.string.formulario3_nome_mae, R.string.formulario3_idade_mae,
			R.string.formulario3_nome_pai, R.string.formulario3_tel_fixo,
			R.string.formulario3_tel_celular1, R.string.formulario3_operadora1,
			R.string.formulario3_tel_celular2, R.string.formulario3_operadora2,
			R.string.formulario3_cobertura_psf,
			R.string.formulario3_peso_nascer,
			R.string.formulario3_idade_gestacional, R.string.formulario3_raca,
			R.string.formulario3_titulo_vacina_contra_varicela,
			R.string.formulario3_n_doses_varic,
			R.string.formulario3_vac_varic_dt_dose1,
			R.string.formulario3_vac_varic_qual_dose1,
			R.string.formulario3_vac_varic_dt_dose2,
			R.string.formulario3_vac_varic_qual_dose2,
			R.string.formulario3_titulo_data_vacina_mmr,
			R.string.formulario2_vac_triplice_viral,//NOVO
			R.string.formulario2_n_doses_triplice_viral,//NOVO
			R.string.formulario3_mmr1,
			R.string.formulario3_mmr2, 
			R.string.formulario3_freq_creche1,
			R.string.formulario3_freq_creche2,
			R.string.formulario3_freq_serv_saude1,
			R.string.formulario3_freq_serv_saude2,
			R.string.formulario3_hospitalizacao,
			R.string.formulario3_mae_trabalha, R.string.formulario3_esc_mae,
			R.string.formulario3_nc_cas_casa5,
			R.string.formulario3_nc_cas_casa10,
			R.string.formulario3_qtd_pessoas_casa,
			R.string.formulario3_qtd_pessoas_quarto,
			R.string.formulario3_doenca_titulo_falciforme,
			R.string.formulario3_doenca_falciforme,
			R.string.formulario3_prematuridade, R.string.formulario3_infec_hiv,
			R.string.formulario3_imuno_deficiencia, R.string.formulario3_asma,
			R.string.formulario3_corticoide, R.string.formulario3_cancer,
			R.string.formulario3_doenca_pulmonar_cronica,
			R.string.formulario3_doenca_renal_cronica,
			R.string.formulario3_doenca_cardiaca,
			R.string.formulario3_doenca_hematologica,
			R.string.formulario3_doenca_hepatica,
			R.string.formulario3_asplenia, R.string.formulario3_diabetes,
			R.string.formulario3_obs_caso };
